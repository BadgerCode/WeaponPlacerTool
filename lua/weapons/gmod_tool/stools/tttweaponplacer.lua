...
local weps = {
   ...
   //CM custom weapons
   weapon_ttt_awp = {name="AWP", snd="item_ammo_357_ttt"},
   weapon_ttt_ak47 = {name="AK47", snd="item_ammo_pistol_ttt"},
   weapon_ttt_dualelite = {name="Dual Elites", snd="item_ammo_pistol_ttt"},
   weapon_ttt_mp5 = {name="MP5", snd="item_ammo_smg1_ttt"},
   weapon_ttt_pump = {name="Pump Shotgun", snd="item_box_buckshot_ttt"},
   weapon_ttt_aug= {name="aug", snd="item_ammo_smg1_ttt"},
   weapon_ttt_explosivegrenade = {name="H.E. Grenade", snd=nil},
...
local mdls = {
   ...
   //CM custom weapons
   weapon_ttt_awp = "models/weapons/w_snip_awp.mdl",
   weapon_ttt_ak47 = "models/weapons/w_rif_ak47.mdl",
   weapon_ttt_dualelite = "models/weapons/w_pist_elite.mdl",
   ...
   weapon_ttt_explosivegrenade = "models/weapons/w_grenade.mdl",
